...
CREATE PROCEDURE Initiate_plan_payment 
    ...
    BEGIN
       ...
       SET @rem_balance = dbo.calculate_remaining_balance(@payment_ID,@plan_id);
       SET @extra_am = dbo.Calculate_Extra_Amount(@payment_ID,@plan_id);
       INSERT INTO Process_Payment VALUES (@payment_ID,@plan_id,@rem_balance,@extra_am);
    END
...
GRANT SELECT ON dbo.Account_Plan_date TO admin;
GRANT SELECT ON dbo.Account_Usage_Plan TO admin;
GRANT EXECUTE ON Benefits_Account TO admin;
GRANT SELECT ON dbo.Account_SMS_Offers TO admin;
...
GRANT SELECT ON dbo.Consumption TO customer;
GRANT EXECUTE ON Unsubscribed_Plans TO customer;
GRANT SELECT ON dbo.Usage_Plan_CurrentMonth TO customer;
GRANT SELECT ON dbo.Cashback_Wallet_Customer TO customer;
...
GRANT SELECT ON dbo.Subscribed_plans_5_Months TO customer;
